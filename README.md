...
> **Historical personal project.** Clawprint was created before Cyntrisec narrowed its company focus to EphemeralML and AIR v1. It is not a current Cyntrisec product, support surface, or commercial offering. The current Cyntrisec product work is EphemeralML: confidential AI inference with cryptographic receipts.
